...
import {
    Trophy, Medal, Crown, Loader2, TrendingUp
} from 'lucide-react';
            ...
            <div className={styles.container}>
                <div className={styles.header}>
                    <div className={styles.titleWrapper}>
                        ...
                        <div>
                            <h1 className={styles.title}>Ranking Mensal Global</h1>
                            <p className={styles.subtitle}>Os Top 10 criadores que mais faturaram este mês na plataforma</p>
                        </div>
                    </div>
                </div>
